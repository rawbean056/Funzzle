 ...
 * @author merin
 */
public class Word_levelController implements Initializable {
    ...
    {
        Parent menuView = FXMLLoader.load(getClass().getResource("word1.fxml"));
    ...
    {
        Parent menuView = FXMLLoader.load(getClass().getResource("word2.fxml"));
        Scene menuViewScene = new Scene(menuView);
    ...
    {
        Parent menuView = FXMLLoader.load(getClass().getResource("word3.fxml"));
        Scene menuViewScene = new Scene(menuView);
