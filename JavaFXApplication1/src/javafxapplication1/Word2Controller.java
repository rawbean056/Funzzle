 ...
 * @author rakin
 */
public class Word2Controller implements Initializable {
    ...
    {
        if(f1.getText().equals("I")&&f2.getText().equals("H")&&f3.getText().equals("R")&&f4.getText().equals("N")&&f5.getText().equals("I")){
