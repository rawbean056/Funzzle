 ...
 * @author rakin
 */
public class Word1Controller implements Initializable {
    ...
    {
        if(f1.getText().equals("I")&&f2.getText().equals("N")&&f3.getText().equals("O")&&f4.getText().equals("C")&&f5.getText().equals("R")){
